            ...
            switch (opcion) {
                ...
                case 3:
                    if (concesionarias.isEmpty()) {
                        System.out.println("No hay donde almacenar carros");
                    } else {
                        int cual;
                        do {
                            System.out.println("""
                            ...
                            switch (cual) {
                                ...
                                case 2:
                                    ...
                                    int queve;
                                    if (concesionarias.get(quecon6).getCarros().isEmpty()) {
                    ...
                    break;
                case 4:
                    if (concesionarias.isEmpty() || clientes.isEmpty() || vehiculos.isEmpty()) {
                        System.out.println("no puede entrar aqui ahorita");
                    } else {
                        int cual4;
                        do {
                            System.out.println("""
                            ...
                            switch (cual4) {
                                ...
                                case 2:
                                    ...
                                    if (clientes.get(cualcli2).getCarrosobtenidos().isEmpty()) {
                                        ...
                                        do {
                                            for (Vehiculo a : clientes.get(cualcli2).getCarrosobtenidos()) {
